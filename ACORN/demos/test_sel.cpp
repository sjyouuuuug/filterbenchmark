...
int main(int argc, char* argv[]) {
    std::cout << "====================\nSTART: running SELECTIVITY_TEST --"
              << nthreads << "cores\n"
              << std::endl;
    ...
    const std::string gt_path = "./Datasets/" + dataset + "/" + dataset +
            "_containment_sel_1_groundtruth.txt";
    const std::string base_label_path = "./Datasets/" + dataset + "/" +
            dataset + "_label_containment_12_base.txt";
    const std::string aq_path = "./Datasets/" + dataset + "/" + dataset +
            "_containment_query_1.txt";
    ...
    { // load query vectors and attributes
        ...
        filename = "./Datasets/" + dataset + "/" + dataset + "_query_1.fvecs";
