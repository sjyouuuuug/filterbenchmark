...
int main(int argc, char* argv[]) {
    ...
    const std::string gt_path =
            "./Datasets/" + dataset + "/graph_search_gt.txt";
    const std::string base_label_path = "./Datasets/" + dataset + "/" +
            dataset + "_label_equal_12_base.txt";
    const std::string aq_path =
            "./Datasets/" + dataset + "/query_graph_search_label.txt";
    ...
    { // load query vectors and attributes
        ...
        bool is_base = 0;
        std::string filename =
                "./Datasets/" + dataset + "/query_graph_search.fvecs";
    ...
    //     std::cerr << "Failed to open query bitmap file: " <<
    //     query_bitmap_path
    //               << std::endl;
    //     return -1;
    // }
    ...
    //     std::cout << "nq: " << nq << "num_queries: " << num_queries <<
    //     std::endl;
