...
int main(int argc, char* argv[]) {
    ...
    const std::string gt_path = "./Datasets/" + dataset + "/zipf_graph_search_gt.txt";
    const std::string base_label_path = "./Datasets/" + dataset + "/" +
            dataset + "_label_zipf_12_base.txt";
    const std::string aq_path = "./Datasets/" + dataset + "/zipf_query_graph_search_label.txt";
    ...
    { // load query vectors and attributes
        ...
        size_t d2;
        bool is_base = 0;
        std::string filename = "./Datasets/" + dataset + "/zipf_query_graph_search.fvecs";
