...
for dataset in datasets:
    for scenario in scenarios:
        ...
        for percentage in [10, 25]:
            ...
            index_path = "../base_experiment/index_files/ACORN/" + str(percentage) + "p"
            ...
            output_path = "../base_experiment/result/ACORN_bitset/" + dataset + "/" + scenario + "_" + str(percentage)
