...
base_path_template = "../data/result/ACORN/{dataset}/{scenario}/M={m}_M_beta={mb}_gamma={gamma}"
    ...
    for mb in M_betas:
        ...
        for gamma in gammas:
            ...
            if not all_recalls or not all_qps:
                print(f"No valid data for M{m}_Mb{mb}_gamma{gamma}")
                continue
            ...
            output_dir = f"../data/result/ACORN/{dataset}/combine/M{m}_M_beta{mb}_gamma{gamma}/"
