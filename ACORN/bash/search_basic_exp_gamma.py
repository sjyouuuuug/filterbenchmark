...
# Constants
map_N = {"tripclick": 1055976, "LAION1M": 1000448, "yfcc": 1000000, "ytb_video": 5000000, "arxiv": 132687}
datasets = ["LAION1M", "arxiv", "ytb_video"]
for dataset in datasets:
    scenarios = ["or", "equal", "and"]
    # scenarios = ["or"]
    k = 10
    for scenario in scenarios:
        if dataset == "tripclick" and scenario == "or":
            continue
        if dataset == "LAION1M" and (scenario == "equal" or scenario == "or"):
            continue
        # for id in [0, 1, 2]:
        ...
        output_path = "../basic_experiment/result/ACORN_gamma/" + dataset + "/" + scenario
