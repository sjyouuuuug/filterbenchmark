...
model_loc = "../indices/{}/".format(datasetName+"Mode"+str(args.mode))
lookups_loc  = "../indices/{}/".format(datasetName+"Mode"+str(args.mode)) + '/epoch_'+ str(eval_epoch)
data_loc = "../../../../data/{}/".format(datasetName)
print (model_loc, lookups_loc, data_loc)
